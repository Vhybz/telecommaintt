    ...
    try {
      ...
      if (phone.isNotEmpty) {
        await ref.read(smsServiceProvider).sendSms(
          phoneNumber: phone,
          message: 'Welcome to Telecom AI, $fullName!\n\nYour account has been created successfully. You can now log in to manage network infrastructure and view AI insights.',
        );
      }
