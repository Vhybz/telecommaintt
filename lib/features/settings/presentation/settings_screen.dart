        ...
        children: [
          ...
          _buildSettingsSection(
            ...
            children: [
              ...
              ref.watch(smsBalanceProvider).when(
                data: (balance) => _buildSettingTile(
                  primaryColor: primaryColor,
                  icon: Icons.sms_outlined,
                  title: 'SMS Balance',
                  subtitle: balance != null ? 'GHS ${balance.toStringAsFixed(2)}' : 'Unavailable',
                  trailing: IconButton(
